...
function TransferTokensButton() {
  const { account, library } = useWeb3React()

  const initiateValueTransfer = useCallback(async () => {
    ...
    try {
      const txHash = await library.send('eth_sendTransaction', [transaction])
